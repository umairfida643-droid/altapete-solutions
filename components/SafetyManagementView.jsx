...
const BENEFITS = [
  {
    ...
    desc: 'Proactively identify and control hazards before they escalate into incidents or injuries.',
  },
  {
    title: 'Full Regulatory Compliance',
    desc: 'Ensure full compliance with OSHA standards and KSA safety regulations without manual tracking.',
  },
  {
    title: 'Faster Incident Response',
    desc: 'Speed up response times with instant alerts, automated escalation workflows, and mobile reporting.',
  },
  {
    title: 'Measurable Safety Culture',
    desc: 'Build a data-driven safety culture with KPI dashboards, trend analytics, and benchmarking.',
  },
  {
    title: 'Eliminate Paper-Based Processes',
    desc: 'Replace manual checklists and paper forms with fully digital inspections and audit workflows.',
  },
  {
    title: 'Protect People & Reduce Liability',
    desc: 'Comprehensive audit trails and incident records protect your workforce and reduce legal exposure.',
  },
];
...
export default function SafetyManagementView() {
  ...
  return (
    <div className={`safety-view-wrapper ${isDark ? 'dark-theme' : 'light-theme'}`}>
          ...
          <div className="row align-items-center justify-content-center text-center">
            <div className="col-xl-9 col-lg-10">
              ...
              <div className="hero-badge">
                <Shield size={14} color="#00AEEF" />
                <span>WORKPLACE SAFETY MANAGEMENT PLATFORM</span>
              </div>
              ...
              <p className="hero-desc">
                Altapete Solutions protects your people and keeps your operations audit-ready — combining incident tracking, risk assessment, PPE management, compliance reporting, and emergency response in one connected platform.
              </p>
      ...
      <section className="safety-features-section">
        <div className="container">
          <div className="section-head text-center">
            ...
            <h2 className="section-title">A Complete Toolkit for Workplace Safety</h2>
            <p className="section-desc">
              Nine integrated modules designed to eliminate hazards, ensure compliance, and protect every worker across your organisation.
            </p>
          </div>
      ...
      {/* 3. BUSINESS BENEFITS */}
      <section className="safety-benefits-section">
        <div className="container">
          <div className="row g-4 g-lg-5 align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <h2 className="section-title text-start mb-3">
                Measurable Safety Improvements Across Your <span className="text-gradient">Entire Workforce</span>
              </h2>
              <p className="section-desc text-start mb-4">
                Paper-based safety processes and disconnected systems leave gaps that cost lives and compliance standing. Our integrated safety ERP automates critical workflows so your team can focus on prevention and protection.
              </p>
            ...
            <div className="col-lg-6">
              <div className="benefit-visual-frame">
                <img
                  ...
                  alt="Industrial workplace safety management"
                  className="benefit-img"
                />
                <div className="visual-stat-overlay">
                  <div className="overlay-badge">
                    <Zap size={14} color="#00AEEF" />
                    <span>Real-Time Safety Engine</span>
                  </div>
                  <div className="overlay-metric">Up to 60% Reduction in Incident Response Time</div>
                  <div className="overlay-note">Backed by automated alerts, escalation workflows & mobile reporting</div>
                </div>
              </div>
            </div>
          ...
          <div className="cp-cta-banner">
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <p className="cp-cta-sub">
                Speak with our safety management specialists to explore custom workflows, OSHA & KSA compliance tracking, and seamless integration with your existing systems.
              </p>
      ...
      <style jsx>{`
        ...
        .safety-hero {
          ...
          position: relative;
          background: linear-gradient(rgba(8,13,26,0.85), rgba(10,22,40,0.9)), url('https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=1920') center/cover no-repeat;
        ...
        :global([data-theme="light"]) .safety-view-wrapper,
        .light-theme.safety-view-wrapper {
          background: #f8fafc;
          color: #0f172a;
        }
        :global([data-theme="light"]) .safety-hero,
        .light-theme .safety-hero {
          background: linear-gradient(rgba(240,247,255,0.92), rgba(255,255,255,0.95)), url('https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=1920') center/cover no-repeat;
        ...
        :global([data-theme="light"]) .safety-benefits-section,
        .light-theme .safety-benefits-section {
          background: #f1f5f9;
