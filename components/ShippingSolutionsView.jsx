          ...
          <div className="row align-items-center justify-content-center text-center">
            <div className="col-xl-9 col-lg-10">
              ...
              <div className="hero-actions">
                <Link href="/contact-us" className="btn btn-linear hover-up btn-hero-primary">
                  <span>Schedule Architecture Demo</span>
                  <ArrowRight size={16} />
                </Link>
                <Link href="/what-we-do" className="btn btn-outline-brand hover-up btn-hero-secondary">
